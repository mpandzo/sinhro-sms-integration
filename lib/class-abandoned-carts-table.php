 ...
 */
class Abandoned_Cart_Admin_List_Table extends WP_List_Table {
	...
	*/
	...
	function column_Email2Sent($item) {
		return $item->email_2_sent;
	}

	function column_Email3Sent($item) {
		return $item->email_3_sent;
	}
	...
	function column_Sms2Sent($item) {
		return $item->sms_2_sent;
	}
  ...
  protected function display_tablenav( $which ) {
	...
	function get_columns() {
      ...
      'Email1Sent'=>esc_html__('Email 1', 'sinhro-sms-integration'),
			'Email2Sent'=>esc_html__('Email 2', 'sinhro-sms-integration'),
			'Email3Sent'=>esc_html__('Email 3', 'sinhro-sms-integration'),
			'Sms1Sent'=>esc_html__('Sms 1', 'sinhro-sms-integration'),
			'Sms2Sent'=>esc_html__('Sms 2', 'sinhro-sms-integration'),
	...
	public function get_sortable_columns() {
		$sortable_columns = array(
			...
			'Email2Sent'=> array( 'email_2_sent', true ),
			'Email3Sent'=> array( 'email_3_sent', true ),
			'Sms1Sent'=> array( 'sms_1_sent', true ),
			'Sms2Sent'=> array( 'sms_2_sent', true ),
